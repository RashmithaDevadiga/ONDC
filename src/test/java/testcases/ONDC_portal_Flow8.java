...
public class ONDC_portal_Flow8 extends BaseTest {
    ...
    @Test
    public void IGM() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow8"), "Flow8");
       Thread.sleep(15000);
