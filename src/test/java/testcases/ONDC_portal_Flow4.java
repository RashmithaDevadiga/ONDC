...
public class ONDC_portal_Flow4  extends BaseTest {
    ...
    @Test
    public void MerchantSideFull_OrderCancel() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow4"), "Flow4");
       Thread.sleep(10000);
