...
public class ONDC_portal_Flow9 extends BaseTest {
    ...
    @Test
    public void NonCancellableFlow() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow9"), "Flow9");
       Thread.sleep(15000);
