...
public class ONDC_portal_Flow7 extends BaseTest {
    ...
    @Test
    public void OutOfStock() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow7"), "Flow7");
       Thread.sleep(15000);
