...
public class ONDC_portal_Flow2  extends BaseTest {
    ...
    @Test
    public void BuyerSideFull_OrderCancel() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow2"), "Flow2");
       Thread.sleep(10000);
