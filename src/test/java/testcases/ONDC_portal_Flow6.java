...
public class ONDC_portal_Flow6 extends BaseTest {
    ...
    @Test
    public void BuyerInitiatedReturnPO() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow6"), "Flow6");
       Thread.sleep(10000);
