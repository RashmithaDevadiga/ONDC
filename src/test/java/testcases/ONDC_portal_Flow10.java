...
public class ONDC_portal_Flow10 extends BaseTest {
    ...
    @Test
    public void SearchAndCustomMenu() throws InterruptedException, IOException {
      ...
      SeleniumUtils.clickElement(loc.getProperty("Domain1"), "Domain1");
       ...
       Thread.sleep(1000);
       SeleniumUtils.clickElement(loc.getProperty("Flow10"), "Flow10");
       Thread.sleep(15000);
